...
const uri = "mongodb+srv://hisham_group11:group11hisham@cluster0.imvf1.mongodb.net/?retryWrites=true&w=majority";
mongoose.connect(uri, {useNewUrlParser: true},()=>{
    console.log("Connection to db ..start")
});
...
// Create a new test
// server.post('/patient/:id/tests/:testId', patientController.addPatient)
